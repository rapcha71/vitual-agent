...
import { pool } from "./db";
// PaymentService eliminado: los pagos son 100% manuales vía el botón del admin
  ...
  (async () => {
    try {
      ...
      server.listen(PORT, "0.0.0.0", async () => {
        ...
        // NOTA: Los pagos son 100% manuales.
        // El administrador marca cada propiedad como pagada desde el panel admin.
        // No hay ningún proceso automático de pagos.
      });
    } catch (error) {
